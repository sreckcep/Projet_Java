...
public class Tests {
    ...
    static public void testHexRound() {
        ...
        Tests.equalHex("hex_round 4", a.hexRound(), new FractionalHex(a.getQ() * 0.4 + b.getQ() * 0.3 + c.getQ() * 0.3, a.getR() * 0.4 + b.getR() * 0.3 + c.getR() * 0.3, a.getS() * 0.4 + b.getS() * 0.3 + c.getS() * 0.3).hexRound());
        Tests.equalHex("hex_round 5", c.hexRound(), new FractionalHex(a.getQ() * 0.3 + b.getQ() * 0.3 + c.getQ() * 0.4, a.getR() * 0.3 + b.getR() * 0.3 + c.getR() * 0.4, a.getS() * 0.3 + b.getS() * 0.3 + c.getS() * 0.4).hexRound());
    }
