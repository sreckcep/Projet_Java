...
public class FractionalHex {
    ...
    public FractionalHex(double q, double r, double s) {
        ...
        this.r = r;
        this.s = s;
        if (Math.round(q + r + s) != 0) throw new IllegalArgumentException("q + r + s doit etre egal a 0");
    }
    ...
    static public ArrayList<Hex> hexLinedraw(Hex a, Hex b) {
        int N = a.distance(b);
        FractionalHex a_nudge = new FractionalHex(a.getQ() + 1e-06, a.getR() + 1e-06, a.getS() - 2e-06);
        FractionalHex b_nudge = new FractionalHex(b.getQ() + 1e-06, b.getR() + 1e-06, b.getS() - 2e-06);
